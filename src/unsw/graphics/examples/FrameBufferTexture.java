...
/**
 * Shows how we can render into the framebuffer then use that as a texture.
 * 
 * @author Robert Clifton-Everest
 *
 */
public class FrameBufferTexture extends Application3D {
    ...
    public static void main(String[] args) {
        FrameBufferTexture example = new FrameBufferTexture();
        example.start();
    }
    ...
    public void init(GL3 gl) {
        ...
        //Render the Transforming fish scene.
        TransformingFish transformingFish = new TransformingFish();
        ...
        gl.glCopyTexImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, 0, 0, viewport[2], viewport[3], 0);
